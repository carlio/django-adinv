...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advert.destination_url'
        db.add_column('adinv_advert', 'destination_url',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'AdSlot.destination_url'
        raise RuntimeError("Cannot reverse this migration. 'AdSlot.destination_url' and its values cannot be restored.")
